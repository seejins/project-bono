...
exports.findPoleTime = findPoleTime;
exports.formatGap = formatGap;
exports.formatLapTime = formatLapTime;
exports.formatSectorTime = formatSectorTime;
exports.calculatePositionChange = calculatePositionChange;
exports.validatePacketHeader = validatePacketHeader;
exports.calculateS3TimeForCompletedLap = calculateS3TimeForCompletedLap;
...
function formatLapTime(timeInMs) {
    if (timeInMs === 0 || timeInMs === undefined)
        return '--:--.---';
 ...
 */
function formatSectorTime(timeInMs, minutes = 0) {
    if (timeInMs === 0 || timeInMs === undefined)
        return '--.---';
    const totalSeconds = timeInMs / 1000;
 ...
 */
function calculatePositionChange(gridPosition, currentPosition) {
 ...
 */
function calculateS3TimeForCompletedLap(lastLapTimeMs, sector1TimeMs, sector1TimeMinutes, sector2TimeMs, sector2TimeMinutes) {
...
//# sourceMappingURL=f123Helpers.js.map