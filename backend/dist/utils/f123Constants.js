...
exports.PACKET_IDS = exports.PENALTY_TYPES = exports.PLATFORM_NAMES = exports.RESULT_STATUS = exports.DRIVER_STATUS = exports.TIRE_COMPOUND_TO_LETTER = exports.SESSION_TYPE_ABBREVIATIONS = exports.SESSION_TYPE_NAMES = exports.TEAM_ID_TO_NAME = exports.TRACK_ID_TO_NAME = void 0;
exports.getTrackName = getTrackName;
exports.getTeamName = getTeamName;
exports.getSessionTypeName = getSessionTypeName;
exports.getSessionTypeAbbreviation = getSessionTypeAbbreviation;
exports.getTireCompound = getTireCompound;
...
exports.TRACK_ID_TO_NAME = new Map([
    [0, 'Melbourne'],
    [1, 'Paul Ricard'],
    [2, 'Shanghai'],
    [3, 'Sakhir (Bahrain)'],
...
exports.TEAM_ID_TO_NAME = new Map([
    [0, 'Mercedes'],
    [1, 'Ferrari'],
    [2, 'Red Bull Racing'],
    [3, 'Williams'],
...
exports.SESSION_TYPE_NAMES = new Map([
    [0, 'Unknown'],
    [1, 'Practice 1'],
    [2, 'Practice 2'],
    [3, 'Practice 3'],
...
exports.SESSION_TYPE_ABBREVIATIONS = new Map([
    [0, 'Unknown'],
    [1, 'P1'],
    [2, 'P2'],
    [3, 'P3'],
...
function getTrackName(trackId) {
    return exports.TRACK_ID_TO_NAME.get(trackId) || 'Unknown Track';
}
// Helper function to get team name
function getTeamName(teamId) {
    return exports.TEAM_ID_TO_NAME.get(teamId) || 'Unknown Team';
}
// Helper function to get session type name
function getSessionTypeName(sessionType) {
    return exports.SESSION_TYPE_NAMES.get(sessionType) || 'Unknown';
}
// Helper function to get session type abbreviation
function getSessionTypeAbbreviation(sessionType) {
    return exports.SESSION_TYPE_ABBREVIATIONS.get(sessionType) || 'Unknown';
}
// Tire Compound Mapping
exports.TIRE_COMPOUND_TO_LETTER = new Map([
    [16, 'S'], // C5 (softest)
    [17, 'S'], // C4
    [18, 'M'], // C3
    [19, 'H'], // C2
...
function getTireCompound(compound) {
    return exports.TIRE_COMPOUND_TO_LETTER.get(compound) || 'M';
}
// Driver Status Mapping (from Lap Data Packet)
exports.DRIVER_STATUS = new Map([
    [0, 'IN_GARAGE'],
...
function getDriverStatus(status) {
    return exports.DRIVER_STATUS.get(status) || 'RUNNING';
}
// Helper function to get result status
function getResultStatus(resultStatus) {
    return exports.RESULT_STATUS.get(resultStatus) || 'RUNNING';
}
// Platform IDs (from spec)
exports.PLATFORM_NAMES = new Map([
    [1, 'Steam'],
    [3, 'PlayStation'],
    [4, 'Xbox'],
    [6, 'Origin'],
...
function getPlatformName(platform) {
    return exports.PLATFORM_NAMES.get(platform) || 'Unknown';
}
// Penalty Types (from spec)
exports.PENALTY_TYPES = new Map([
    [0, 'Drive through'],
    [1, 'Stop Go'],
    [2, 'Grid penalty'],
    [3, 'Penalty reminder'],
...
//# sourceMappingURL=f123Constants.js.map